...
const Search = () => {
  return (
    <div className='bg-[#1D1F25]'>
        ...
        <form className="flex items-center ml-8 pb-8 md:mr-auto ">   
    <div className="relative w-full  ">
        <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
            
            <RiSearchLine className='text-[#757B8C] pl-0.5'/>
        </div>
        <input type="text" className="bg-[#282C38] text-[#757B8C] text-sm rounded-md  block md:w-96 w-50 pl-10 p-2.5
         " placeholder="Find Courses" required/>
    </div>
    </form>
    <svg className='invisible md:visible' width="43" height="43" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<svg className='invisible md:visible ml-5 mr-8' width="43" height="43" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
